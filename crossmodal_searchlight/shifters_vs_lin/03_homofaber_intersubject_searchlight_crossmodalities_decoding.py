...
def run_crossmodal_searchlight(split_ind, train_modality, test_modality, searchlight_radius):
    ...
    test_key = 'test_{}'.format(test_modality)
    ...
    single_split_path = op.join(single_split_res_dir,'intersubj_balancedacc_rad{:05.2f}mm_train{}test{}_split{:02d}of{:02d}.nii.gz'.format(searchlight_radius,train_modality,test_modality,split_ind+1,n_splits))
